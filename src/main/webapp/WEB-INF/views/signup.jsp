        ...
        <div class="card bg-light text-dark" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
			...
			<div data-mdb-input-init class="form-outline form-white mb-4">
              ...
              <button data-mdb-button-init data-mdb-ripple-init class="btn  btn-success text-white btn-outline-dark btn-lg px-5" type="submit">Signup</button>
			</form>
		
            </div>
			<p class="mt-2" style="color:red">${msg}</p>
            <div>
              <p class="mb-0">have an account? <a href="login" class="text-black-50 fw-bold">Signin</a>
              </p>
            </div>
